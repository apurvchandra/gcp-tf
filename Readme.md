...
This repository provides a modular and scalable Terraform-based implementation of a **Google Cloud Landing Zone**. It follows best practices from the Google Cloud Foundation Toolkit (CFT) to help organizations bootstrap, organize, and secure their GCP environments.
